...
const GenericTestTemplate: TOC<Signature> = <template>
  ...
  <main class='generic-flow-page'>
    <EmberFlow
      ...
      @edgeTypes={{@model.flowProps.edgeTypes}}
      ...
      @nodesFocusable={{@model.flowProps.nodesFocusable}}
      @edgesFocusable={{@model.flowProps.edgesFocusable}}
      ...
      @connectionLineType={{@model.flowProps.connectionLineType}}
      @connectionLineStyle={{@model.flowProps.connectionLineStyle}}
      @connectionLineContainerStyle={{@model.flowProps.connectionLineContainerStyle}}
      @connectionLineComponent={{@model.flowProps.connectionLineComponent}}
      @connectionDragThreshold={{@model.flowProps.connectionDragThreshold}}
      @defaultEdgeOptions={{@model.flowProps.defaultEdgeOptions}}
      @paneClickDistance={{@model.flowProps.paneClickDistance}}
      @selectionKey={{@model.flowProps.selectionKey}}
      @selectionKeyCode={{@model.flowProps.selectionKeyCode}}
      @selectionOnDrag={{@model.flowProps.selectionOnDrag}}
      @selectionMode={{@model.flowProps.selectionMode}}
      @onlyRenderVisibleElements={{@model.flowProps.onlyRenderVisibleElements}}
      @deleteKey={{@model.flowProps.deleteKey}}
      @deleteKeyCode={{@model.flowProps.deleteKeyCode}}
      @multiSelectionKey={{@model.flowProps.multiSelectionKey}}
      @multiSelectionKeyCode={{@model.flowProps.multiSelectionKeyCode}}
      @onInit={{@model.flowProps.onInit}}
      @onNodeClick={{@model.flowProps.onNodeClick}}
      @onNodeDoubleClick={{@model.flowProps.onNodeDoubleClick}}
      @onNodeContextMenu={{@model.flowProps.onNodeContextMenu}}
      @onEdgeClick={{@model.flowProps.onEdgeClick}}
      @onEdgeDoubleClick={{@model.flowProps.onEdgeDoubleClick}}
      @onEdgeContextMenu={{@model.flowProps.onEdgeContextMenu}}
      @onEdgeMouseEnter={{@model.flowProps.onEdgeMouseEnter}}
      @onEdgeMouseMove={{@model.flowProps.onEdgeMouseMove}}
      @onEdgeMouseLeave={{@model.flowProps.onEdgeMouseLeave}}
      @onPaneClick={{@model.flowProps.onPaneClick}}
      @onPaneMouseEnter={{@model.flowProps.onPaneMouseEnter}}
      @onPaneMouseMove={{@model.flowProps.onPaneMouseMove}}
      @onPaneMouseLeave={{@model.flowProps.onPaneMouseLeave}}
      @onPaneScroll={{@model.flowProps.onPaneScroll}}
      @onPaneContextMenu={{@model.flowProps.onPaneContextMenu}}
      @onViewportChangeStart={{@model.flowProps.onViewportChangeStart}}
      @onViewportChange={{@model.flowProps.onViewportChange}}
      @onViewportChangeEnd={{@model.flowProps.onViewportChangeEnd}}
      @onBeforeDelete={{@model.flowProps.onBeforeDelete}}
      @onNodesDelete={{@model.flowProps.onNodesDelete}}
      @onEdgesDelete={{@model.flowProps.onEdgesDelete}}
      @onDelete={{@model.flowProps.onDelete}}
      ...
      @onSelectionDragStart={{@model.flowProps.onSelectionDragStart}}
      @onSelectionDrag={{@model.flowProps.onSelectionDrag}}
      @onSelectionDragStop={{@model.flowProps.onSelectionDragStop}}
      @onSelectionStart={{@model.flowProps.onSelectionStart}}
      @onSelectionEnd={{@model.flowProps.onSelectionEnd}}
      @onSelectionContextMenu={{@model.flowProps.onSelectionContextMenu}}
    ...
    >
      ...
      {{#if @model.minimapProps}}
        <MiniMap
          ...
          @nodeComponent={{@model.minimapProps.nodeComponent}}
