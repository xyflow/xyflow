...
@Injectable()
export class FlowStateService<NodeType extends Node = Node, EdgeType extends Edge = Edge> implements OnDestroy {
  ...
  private nodeTypesSubject = new BehaviorSubject<NodeTypes>({});
  private edgeTypesSubject = new BehaviorSubject<EdgeTypes>({});
  ...
  private parentLookupSubject = new BehaviorSubject<Map<string, string>>(new Map());
  ...
  private onBeforeConnectSubject = new BehaviorSubject<OnBeforeConnect | null>(null);
  ...
  private fitViewOptionsSubject = new BehaviorSubject<FitViewOptions | undefined>(undefined);
  ...
  readonly selectedNodes$ = this.selectedNodesSubject.asObservable();
  readonly selectedEdges$ = this.selectedEdgesSubject.asObservable();
  readonly edgeTypes$ = this.edgeTypesSubject.asObservable();
  readonly connection$ = this.connectionSubject.asObservable();
  readonly transform$ = this.transformSubject.asObservable();
  readonly dimensions$ = this.dimensionsSubject.asObservable();
  ...
  get nodeTypes(): NodeTypes { return this.nodeTypesSubject.value; }
  get edgeTypes(): EdgeTypes { return this.edgeTypesSubject.value; }
  ...
  addSelectedNodes(selectedNodeIds: string[]): void {
    ...
    this.triggerNodeChanges(getSelectionChanges(nodeLookup, new Set([...selectedNodeIds]), true));
  ...
  addSelectedEdges(selectedEdgeIds: string[]): void {
    ...
    this.triggerNodeChanges(getSelectionChanges(nodeLookup, new Set(), true));
  }
  ...
  setOnBeforeConnect(onBeforeConnect: OnBeforeConnect | null): void {
