...
const createStore = ({
  ...
  const storeCreator: StateCreator<ReactFlowState> = (set, get) => {
    ...
    return {
      ...
      setNodes: (nodes: Node[]) => {
        ...
        if (fitViewQueued && nodesInitialized) {
          ...
          set({ nodes, updatedNodes, nodesInitialized, nodesSelectionActive: nextNodesSelectionActive });
        }
      },
      setEdges: (edges: Edge[]) => {
      ...
      setNodeExtent: (nextNodeExtent) => {
        ...
        set({ nodeExtent: nextNodeExtent, updatedNodes });
      },
  ...
  return create<ReactFlowState>()(middleware(storeCreator));
};
