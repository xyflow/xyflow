...
export const getInitialStore = () => {
  ...
  const store = Object.defineProperties<SvelteFlowStoreState>(
    ...
    {},
    {
      ...
      edgesInitialized: signal<SvelteFlowStoreState['edgesInitialized']>(false),
      ...
      initialized: signal<SvelteFlowStoreState['initialized']>(false),
      ...
      nodesInitialized: signal<SvelteFlowStoreState['nodesInitialized']>(false),
