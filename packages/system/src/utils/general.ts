...
/**
 * Overlapping area of two rectangles given as scalars — avoids allocating a `Rect` per call (used by
 * `getNodesInside`, which checks every node against the viewport on each frame).
 */
