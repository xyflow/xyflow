...
export type XYDragParams<NodeType extends NodeBase = NodeBase> = {
  getStoreItems: <EdgeType extends EdgeBase>() => StoreItems<NodeType, EdgeType>;
...
export function XYDrag<NodeType extends NodeBase = NodeBase>({
  onNodeMouseDown,
  getStoreItems,
  onDragStart,
  onDrag,
  onDragStop,
}: XYDragParams<NodeType>): XYDragInstance {
