 ...
 */
export function useVueFlowStore<NodeType extends Node = Node, EdgeType extends Edge = Edge>(): VueFlowState<NodeType, EdgeType> {
  const state = injectFlowContext<VueFlowState<NodeType, EdgeType>>(VueFlowStateKey);
