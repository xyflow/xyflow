...
/// A bezier curve edge widget.
///
/// This widget renders a smooth bezier curve between two points.
/// Use this when you want a curved connection between nodes.
class BezierEdge extends StatelessWidget {
  /// Creates a bezier edge.
  const BezierEdge({
    super.key,
    required this.id,
  ...
  /// Curvature of the bezier curve (0-1).
  ...
  Widget build(BuildContext context) {
    ...
    final edgePath = BezierEdgePath.getBezierPath(
      sourceX: sourceX,
      sourceY: sourceY,
      targetX: targetX,
      targetY: targetY,
