...
/// A straight line edge widget.
///
/// This widget renders a direct straight line between two points.
class StraightEdge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final edgePath = StraightEdgePath.getStraightPath(
      sourceX: sourceX,
      sourceY: sourceY,
      targetX: targetX,
      targetY: targetY,
