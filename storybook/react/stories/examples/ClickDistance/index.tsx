...
export type ClickDistanceExampleProps = {
  paneClickDistance?: number;
};

export function ClickDistanceExample({ paneClickDistance = 0 }: ClickDistanceExampleProps) {
...
export default ClickDistanceExample;
