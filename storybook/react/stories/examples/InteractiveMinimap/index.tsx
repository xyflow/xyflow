...
export type InteractiveMinimapExampleProps = {
  inversePan?: boolean;
};

function InteractiveMinimapFlow({ inversePan = false }: InteractiveMinimapExampleProps) {
  ...
  return (
    ...
    >
      ...
      <MiniMap onClick={onMiniMapClick} onNodeClick={onMiniMapNodeClick} pannable zoomable inversePan={inversePan} />
      <Controls />
...
export function InteractiveMinimapExample(props: InteractiveMinimapExampleProps) {
  return (
    <ReactFlowProvider>
      <InteractiveMinimapFlow {...props} />
    </ReactFlowProvider>
  );
}

export default InteractiveMinimapExample;
