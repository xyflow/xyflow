...
export type SharedControlsArgs = {
  showZoom?: boolean;
  showFitView?: boolean;
...
export const defaultControlsArgs: SharedControlsArgs = {
  showZoom: true,
  showFitView: true,
...
export function controlsArgTypes(framework: FlowFramework): StoryArgTypes {
