<script lang="ts">
  import { Handle, Position, useOnSelectionChange, type BuiltInNode, type NodeProps } from '@xyflow/svelte';

  let { data = { label: 'Node' }, positionAbsoluteX = 0, positionAbsoluteY = 0 }: NodeProps<BuiltInNode> = $props();
