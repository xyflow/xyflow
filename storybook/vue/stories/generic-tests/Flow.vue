...
import { useFlowFixture } from '../../../shared/vue/useFlowFixture';
...
const { nodes, edges, resetKey } = useFlowFixture({
  nodes: initialNodes,
...
<template>
  <div class="generic-test-flow">
    ...
    <VueFlow :key="resetKey" id="1" v-model:nodes="nodes" v-model:edges="edges" v-bind="flowProps" @connect="onConnect">
